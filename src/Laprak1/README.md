...
## 📁 Struktur Berkas
* `Smartphone.java`: Class yang merepresentasikan objek Smartphone (berisi atribut, setter, dan getter).
* `Main.java`: Class utama untuk menjalankan program (*entry point*).
